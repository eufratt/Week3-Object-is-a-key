...
function shoppingTime(memberId, money) {
    ...
    let listPurchased = [];
    if(changeMoney >= 1500000) {listPurchased.push('Sepatu Stacattu'); changeMoney -= 1500000;}
    if(changeMoney >= 500000) {listPurchased.push('Baju Zoro'); changeMoney -= 500000;}
    if(changeMoney >= 250000) {listPurchased.push('Baju H&N'); changeMoney -= 250000;}
    if(changeMoney >= 175000) {listPurchased.push('Sweater Uniklooh'); changeMoney -= 175000;}
    if(changeMoney >= 50000) {listPurchased.push('Casing Handphone'); changeMoney -= 50000;}
    let hasil = {
        memberId: memberId,
        money: money,
